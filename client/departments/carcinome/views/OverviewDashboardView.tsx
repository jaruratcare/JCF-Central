            ...
            <CardContent>
              <div className="space-y-2.5">
                {tasksDueToday.slice(0, 5).map((task) => (
                  <div
                    key={task.id}
                    className="flex items-start gap-3 p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg hover:border-indigo-300 transition-colors"
                  >
                    <input
                      type="checkbox"
